...
ফরওয়ার্ড প্রক্সি হল, এক বা একাধিক ক্লায়েন্ট যখন সার্ভারকে সরাসরি রিকুয়েস্ট না করে অন্য একটি সার্ভারের মাধ্যমে রিকুয়েস্ট করে। ফরওয়ার্ড প্রক্সি-তে ক্লায়েন্ট প্রক্সি সার্ভারের মাধ্যমে রিকুয়েস্ট করবে এবং সার্ভার জানবে না কোন ক্লায়েন্ট তাকে রিকুয়েস্ট দিয়েছে। 
...
আমরা যদি প্রাক্টিকালি বলতে যাই, লোড ব্যালেন্সিং একটি টেকনিক যা আমাদের ক্লায়েন্ট রিকুয়েস্টকে একাধিক সার্ভারে ডিসট্রিবিউট করতে পারে। উদাহরণ হল, NGINX।
