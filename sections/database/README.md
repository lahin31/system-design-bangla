...
➡️ প্রথমে MySQL genre ইনডেক্স ব্যবহার করে matching row গুলোর Primary Key (PK) খুঁজে বের করে।
➡️ তারপর প্রতিটা row এর জন্য মূল টেবিল (clustered index / heap) এ গিয়ে সকল কলাম পড়ে নিয়ে আসবে।
➡️ মানে অতিরিক্ত disk/page read লাগে → I/O বাড়ে → query ধীর হয়।
