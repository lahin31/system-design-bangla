...
## Uber কেনো PostgreSQL থেকে MySQL-এ মাইগ্রেট করেছিল?

যদি একটি টেবিলে ছয়টি কলাম আর তিনটি ইনডেক্স থাকে, তাহলে প্রতিটি INSERT-এ সবগুলো ইনডেক্স আপডেট হয়। আর UPDATE-এর ক্ষেত্রে, শুধুমাত্র যে কলামটি পরিবর্তিত হয়েছে, সেই কলামের সাথে সম্পর্কিত ইনডেক্সগুলোই আপডেট হওয়া উচিত।

কিন্তু PostgreSQL-এ যখন কোনো UPDATE হয়, তখন মূল টেবিলে(Heap) একটা নতুন row তৈরি হয় (tuple)।

নতুন row-তে আপডেট হওয়া কলামটি একটি নতুন পয়েন্টার পায়, আর পুরনো row টিকে ডেড (dead) হিসেবে চিহ্নিত করা হয়।
যেহেতু এটি একটি সম্পূর্ণ নতুন row, তাই পুরনো row টিকে যতগুলো ইনডেক্স refer/point করছিল, সবগুলো ইনডেক্সকেই নতুন row এর দিকে পয়েন্ট করার জন্য আপডেট করতে হয়। ফলে অপ্রয়োজনীয় ইনডেক্স আপডেট হয়ে থাকে।

অন্যদিকে, MySQL (InnoDB) ব্যাপারটা অন্যভাবে করে:
