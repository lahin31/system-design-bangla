...
## Section 4: Distributed System

ডিস্ট্রিবিউটেড সিস্টেম হল, একাধিক কম্পিউটার (বা কম্পোনেন্ট) একসাথে কাজ করার ফলে একটি কাজ শেষ করে এবং End User এর কাছে একটি কম্পিউটার হিসেবে আসে। এই মেশিনগুলোতে শেয়ার্ড স্টেট(Shared State) থাকে, কঙ্কারেন্টলি (Concurrently) কাজ করতে পারে, প্রতিটি সিস্টেম একে অপরের সাথে Information শেয়ার করতে পারবে।

বর্তমান সময়ে Distributed System এর উদাহরণ হল cloud-based virtual server instances।

Distributed System আমাদের স্কেলিং করতে সাহায্য করে। 
