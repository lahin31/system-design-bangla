...
- [Section 12: Sharding](#section-12-sharding)
- [Section 13: Database Replication](#section-13-database-replication)
- [Section 14: Caching](#section-14-caching)
- [Section 15: Content Delivery Network](#section-15-content-delivery-network)
- [Section 16: Consistent Hashing]
- [Section 17: CAP Theorem]
- [Section 18: Message Queue]
- [Section 19: Design URL Shortener]
- [Section 20: Design a Rate Limiter]
- [Section 21: Design a Chat System]
- [Section 22: Design a Notification System]
- [Section 23: Resources](#section-23-resources)
...
এপ্লিকেশন ডেভেলপ করার সময় আমাদের কাজ অনুযায়ী ডাটাবেস নির্বাচন করতে হয়। সাধারণত, আমরা প্রধান দুই ধরনের ডাটাবেস ব্যাবহার করে থাকি - SQL(রিলেশনাল) ডাটাবেস এবং NoSQL(নন-রিলেশনাল) ডাটাবেস। আমরা কেমন বা কোন ধরণের ডাটা ষ্টোর করতে চাই, কিভাবে ষ্টোর করতে চাই, আমাদের কাজের পদ্ধতি ইত্যাদি প্রয়োজন অনুযায়ী ডাটাবেস বাছাই করতে হয়। ডাটার ধরন অনুযায়ী ডাটাবেসগুলো আমাদের ভিন্ন ভিন্ন সুবিধা দিয়ে থাকে।
...
## Section 13: Database Replication
...
## Section 15: Content Delivery Network
